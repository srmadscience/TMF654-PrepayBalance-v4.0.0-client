...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2023-10-06T18:35:09.617630+01:00[Europe/Dublin]")public class EventsSubscriptionApi {
  ...
  public EventSubscription registerListener(EventSubscriptionInput body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling registerListener");
    }
  ...
  public void unregisterListener(String id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling unregisterListener");
    }
    // create path and map variables
