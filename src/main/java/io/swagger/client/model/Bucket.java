...
import io.swagger.client.model.BucketStatusType;
...
public class Bucket {
  ...
  **/
  ...
  public Bucket confirmationDate(OffsetDateTime confirmationDate) {
  ...
  **/
  ...
  public Bucket requestedDate(OffsetDateTime requestedDate) {
