...
public class ReserveBalanceUpdate {
  ...
  public ReserveBalanceUpdate confirmationDate(OffsetDateTime confirmationDate) {
  ...
  **/
  ...
  public ReserveBalanceUpdate requestedDate(OffsetDateTime requestedDate) {
