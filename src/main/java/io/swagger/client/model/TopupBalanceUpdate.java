...
public class TopupBalanceUpdate {
  ...
  public TopupBalanceUpdate confirmationDate(OffsetDateTime confirmationDate) {
  ...
  **/
  ...
  public TopupBalanceUpdate requestedDate(OffsetDateTime requestedDate) {
