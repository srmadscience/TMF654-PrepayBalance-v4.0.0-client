...
/**
 * API tests for BalanceActionHistoryApi
 */
@Ignore
public class BalanceActionHistoryApiTest {

    private final BalanceActionHistoryApi api = new BalanceActionHistoryApi();
     ...
     */
    @Test
    public void listBalanceActionHistoryTest() throws Exception {
        String fields = null;
        Integer offset = null;
        Integer limit = null;
        List<BalanceActionHistory> response = api.listBalanceActionHistory(fields, offset, limit);
     ...
     */
    @Test
    public void retrieveBalanceActionHistoryTest() throws Exception {
        String id = null;
        String fields = null;
        BalanceActionHistory response = api.retrieveBalanceActionHistory(id, fields);
