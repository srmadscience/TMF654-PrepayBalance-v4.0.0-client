...
/**
 * API tests for AccumulatedBalanceApi
 */
@Ignore
public class AccumulatedBalanceApiTest {

    private final AccumulatedBalanceApi api = new AccumulatedBalanceApi();
     ...
     */
    @Test
    public void listAccumulatedBalanceTest() throws Exception {
        String fields = null;
        Integer offset = null;
        Integer limit = null;
        List<AccumulatedBalance> response = api.listAccumulatedBalance(fields, offset, limit);
     ...
     */
    @Test
    public void retrieveAccumulatedBalanceTest() throws Exception {
        String id = null;
        String fields = null;
        AccumulatedBalance response = api.retrieveAccumulatedBalance(id, fields);
